...
public class LockPatternView extends View {
    ...
    private void startLineEndAnimation(final CellState state,
                                       final float startX, final float startY, final float
                                               targetX, final float targetY) {
    ...
    private void startSizeAnimation(float start, float end, long duration, Interpolator
            interpolator,
    ...
    public boolean onHoverEvent(MotionEvent event) {
        ...
        try {
            Method getInstance = AccessibilityManager.class.getDeclaredMethod("getInstance",
                    Context.class);
            getInstance.setAccessible(true);
            Object object = getInstance.invoke(AccessibilityManager.class, getContext());
            AccessibilityManager manager = (AccessibilityManager) object;
   ...
   /* @Override
    ...
    private static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcelable superState, String serializedPattern, int displayMode,
                           boolean inputEnabled, boolean inStealthMode, boolean
