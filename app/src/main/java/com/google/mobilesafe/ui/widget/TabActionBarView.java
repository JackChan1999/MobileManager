...
public class TabActionBarView extends LinearLayout implements View.OnClickListener {
    ...
    public TabActionBarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(getContext(),R.layout.action_item_tab, this);
        mLeftTextView = (TextView) findViewById(R.id.action_tab_left);
        mMiddleTextView = (TextView) findViewById(R.id.action_tab_middle);
        mRightTextView = (TextView) findViewById(R.id.action_tab_right);
    }
